...
//////////////////////////////////////////////////////////////////////////////////////////////////////
////This macro make comparison histograms of Int_t type variables for low vs high pileup studies.   // 
////For Float_t type variables, use plots_loop_F.C						    //
////Fill in the user inputs below and then run with "root -l plots_loop_I.C"			    //
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
void plots_loop_I()
{
	...
	//Specify number of Int_t type varaibles you want to plot
	const int numVars = 2;

	//Add Branch names exactly as they appear 
	const char * varNames[numVars] = {"nvtx", "Class_label"};
